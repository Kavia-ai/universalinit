...
from universalinit.universalinit import ProjectInitializer, TemplateProvider, SolanaNextJSTemplate
...
def project_config(temp_dir):
    ...
    return ProjectConfig(
        ...
        author="Test Author",
        project_type=ProjectType.SOLANANEXTJS,
...
def test_nextjs_init_info(template_dir, project_config):
    ...
    initializer.template_factory.register_template(ProjectType.SOLANANEXTJS, SolanaNextJSTemplate)
...
def test_config_file_loading(temp_dir):
    ...
    assert config.project_type == ProjectType.SOLANANEXTJS
